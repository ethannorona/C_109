...
#Creating a list of sum of two dice, rolled 1,000 times
dice_result = []
...
print("Stardard Deviation is -> " + format(std_deviation))
print("Median of the data is -> " + format(median))
print("Mode of the data is -> " + format(mode))

#Finding one stardard deviation start and end values, and two stardard deviation start and end values
first_std_deviation_start, first_std_deviation_end = mean - std_deviation, mean + std_deviation
second_std_deviation_start, second_std_deviation_end = mean - (2*std_deviation), mean + (2*std_deviation)
third_std_deviation_start, third_std_deviation_end = mean - (3*std_deviation), mean + (3*std_deviation)

#Finding the percentage of stardard deviations
